...
// Component ported from React Bits (https://reactbits.dev) & Juan Fuentes
  ...
  return (
    <div
      ...
      style={{
        ...
        display: autoWidth ? 'inline-flex' : 'block',
        alignItems: 'center',
      }}
    >
      {styleElement}
      <h1
        ...
        style={{
          ...
          fontWeight: 100,
          width: autoWidth ? 'auto' : '100%',
          display: autoWidth ? 'inline-flex' : undefined,
          gap: autoWidth ? '0.04em' : undefined,
          color: textColor,
        }}
      >
        {chars.map((char, i) => (

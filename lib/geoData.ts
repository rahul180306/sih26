...
export const CITIES_DATA: Record<string, DeploymentCity> = {
    ...
    drainageEdges: [
      {
        ...
        length_m: 650, diameter_m: 1.2, shape: 'circular', material: 'Box Culvert', slope: 0.020, manningN: 0.013,
      ...
      },
      {
        ...
        length_m: 3500, diameter_m: 2.4, shape: 'circular', material: 'HDPE', slope: 0.0018, manningN: 0.012,
  ...
  pune: {
    ...
    lng: 73.8567,
    type: 'primary',
    statusLabel: 'OPERATIONAL DRAINAGE & DAM TELEMETRY',
    tag: 'MUTHA RIVER BASIN',
    risk: 'High',
    riskColor: '#EF4444',
    maxDepth: '0.95 m',
    rainfall: '68 mm/hr',
    ...
    catchments: [
      {
        ...
        targetNodeId: 'PUN-N-01',
        depth: '0.95 m',
        depthVal: 0.95,
        risk: 'High',
        riskColor: '#EF4444',
        drainage: '92% Capacity',
        affectedRoads: 14,
        description: 'Khadakwasla Dam spillway discharge surge causing riverbank inundation.',
      },
      {
        id: 'bhide-bridge',
        name: 'Baba Bhide Bridge / Deccan Gymkhana',
        lat: 18.5180,
        lng: 73.8480,
        area_km2: 2.1,
        imperviousnessPct: 88,
        rainfall_mmhr: 55,
        runoffCoefficient: 0.85,
        targetNodeId: 'PUN-N-02',
        depth: '0.88 m',
        depthVal: 0.88,
        risk: 'High',
        riskColor: '#EF4444',
        drainage: '89% Capacity',
        affectedRoads: 10,
        description: 'Mutha river flood line submerged low-level causeway.',
      },
      {
        id: 'sangamwadi',
        ...
        lng: 73.8780,
        area_km2: 4.5,
        imperviousnessPct: 76,
        rainfall_mmhr: 48,
        runoffCoefficient: 0.72,
        targetNodeId: 'PUN-N-03',
        depth: '0.58 m',
        depthVal: 0.58,
        risk: 'Medium',
        riskColor: '#F59E0B',
        drainage: '78% Capacity',
        affectedRoads: 4,
        description: 'Mula-Mutha river confluence backflow monitoring point.',
      },
    ],
    drainageNetwork: [
      {
        name: 'Ambil Odha Trunk Conduit',
        status: 'Surcharged',
        type: 'trunk',
        lengthKm: 7.2,
        capacityPct: 91,
      ...
      {
        name: 'Nagzari Nala Old City Spine',
        status: 'High Load',
        type: 'trunk',
        lengthKm: 5.1,
        capacityPct: 85,
  ...
  hyderabad: {
    ...
    catchments: [
      {
        id: 'moosarambagh',
        name: 'Moosarambagh / Chaderghat Basin',
        lat: 17.3720,
        lng: 78.5080,
        area_km2: 4.8,
        imperviousnessPct: 84,
        rainfall_mmhr: 65,
        runoffCoefficient: 0.82,
        targetNodeId: 'HYD-N-01',
        depth: '0.85 m',
        depthVal: 0.85,
        risk: 'High',
        riskColor: '#EF4444',
        drainage: '93% Capacity',
        affectedRoads: 16,
        description: 'Musi river surge from Osman Sagar flood gate release.',
      },
      {
        id: 'nadeem-colony',
        ...
        targetNodeId: 'HYD-N-02',
        depth: '0.72 m',
        depthVal: 0.72,
        risk: 'High',
        riskColor: '#EF4444',
        drainage: '90% Capacity',
        affectedRoads: 11,
        description: 'Low-lying depression basin with heavy stormwater runoff pooling.',
      },
      {
        id: 'begumpet',
        name: 'Begumpet / Brahmanwadi Nala',
        lat: 17.4420,
        lng: 78.4720,
        area_km2: 3.5,
        imperviousnessPct: 80,
        ...
        drainage: '79% Capacity',
        affectedRoads: 7,
        description: 'Picket Nala confluence backflow near railway underpass.',
      },
    ],
    drainageNetwork: [
      {
        name: 'Kukatpally Macro Nullah',
        status: 'Surcharged',
        type: 'trunk',
        lengthKm: 6.8,
        capacityPct: 92,
      ...
      {
        name: 'Hussain Sagar Surplus Outfall',
        status: 'Active Discharge',
        type: 'trunk',
        lengthKm: 3.8,
        capacityPct: 88,
...
export const NATIONAL_HIGHLIGHT_CITIES = ['mumbai', 'delhi', 'chennai', 'bengaluru', 'hyderabad', 'pune', 'kolkata'];
